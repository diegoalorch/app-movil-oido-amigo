...
class Reporte1 extends StatefulWidget {
  Reporte1({Key? key, required this.ses1service}) : super(key: key);
  Ses1Service ses1service;

  @override
  _Reporte1State createState() => _Reporte1State();
}

class _Reporte1State extends State<Reporte1> {
